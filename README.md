...
[![Kimi K2.7 Code](https://gcdn.moonshot.cn/growth-cdn/sponsor/kimi-zh.png)](https://platform.kimi.ai?track_id=track-20d65732f0aa45dcb1df9691a15610af&aff=cc-switch)

Kimi K3 是 Moonshot AI 迄今能力最强的模型，也是全球首个开源 3T 级模型。K3 拥有 2.8T 参数、原生视觉能力与 100 万 Token 上下文，在长程编码、知识工作和推理任务中展现前沿性能。使用 CC Switch，可以在各类 Agent 工具中便捷配置和切换 Kimi。**[点击此处开始使用 Kimi](https://platform.kimi.ai?track_id=track-20d65732f0aa45dcb1df9691a15610af&aff=cc-switch)**

**新用户首充优惠**：通过[此链接](https://platform.kimi.ai?track_id=track-20d65732f0aa45dcb1df9691a15610af&aff=cc-switch)注册并完成首次充值，可获得充值金额 10% 的 API 赠额，最高 ¥1,000。
...
<td>感谢 AICoding 赞助了本项目！AICoding 是全球 AI 模型 API 中转服务商，价格极具竞争力！Claude Code 仅官方价 1.9 折、GPT 仅 1 折！服务数百家企业用户，提供高性价比的 AI 服务。支持 Claude Code、GPT、Gemini 及主流国产模型，企业级高并发、极速开票、7×24 专属技术支持。通过<a href="https://aicoding.inc/i/CCSWITCH">此链接</a>注册的 CC Switch 用户首次充值可享 9 折优惠！</td>
</tr>
